    ...
    <div class="mt-2 pb-3 mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800">
        <div class="py-4 px-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            @forelse ($data as $item)
                <div wire:click="penilaian({{ $item->id }})" class="border border-gray-400 bg-sky-600 items-center text-center py-2 px-2 text-white rounded-md hover:bg-sky-700 cursor-pointer">
        ...
        <div class="text-center text-md text-gray-700">
            <a class="bg-red-600" href="{{ route('update-station') }}">Update Station</a>
        </div>
    </div>
</div>
